...
1. In the Arduino IDE, open the "Sketch" menu, select "Include Library", then
   "Manage Libraries...".
2. Search for "MC33926Driver".
3. Click the MC33926Driver entry in the list.
4. Click "Install".
...
1. Download the
   ...
   and decompress it.
2. Rename the folder "dual-mc33926-motor-shield-xxxx" to "MC33926Driver".
3. Drag the "MC33926Driver" folder into the "libraries" directory inside your
...
selecting "Examples", and then selecting "MC33926Driver".  If
...
- `MC33926Driver()` <br> Default constructor, selects the
  default pins as connected by the motor shield.
- `MC33926Driver(unsigned char M1DIR, unsigned char M1PWM,
